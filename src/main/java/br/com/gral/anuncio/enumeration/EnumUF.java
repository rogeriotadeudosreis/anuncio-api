...
public enum EnumUF {
	...
	ACRE("Acre", "AC", "Rio Branco"), ALAGOAS("Alagoas", "AL", "Maceió"), AMAPA("Amapá", "AP", "Macapá"),
	AMAZONAS("Amazonas", "AM", "Manaus"), BAHIA("Bahia", "BA", "Salvador"), CEARA("Ceará", "CE", "Fortaleza"),
	MATO_GROSSO("Mato Grosso", "MT", "Cuiabá"), PARA("Pará", "PA", "Belém"),
	...
	PARANA("Paraná", "PR", "Curitiba"), PERNAMBUCO("Pernambuco", "PE", "Recife"),
